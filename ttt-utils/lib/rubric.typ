...
#import "assignments.typ": question, is-assignment, _question_counter, point-tag, get-assignment-collect-points
...
#let rubric(
  ...
  ..rest
    ...
    context {
      ...
      context [#metadata((type: "ttt-question", num: _question_counter.get() ,points: points, level: level)) #label("ttt-rubric-label")]
    }
